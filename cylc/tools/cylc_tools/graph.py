...
-----------
    ...
    workflow suite graph images; ll Cylc versions <= 7.9.3 are
...
from cylc_tools import error as __error__

# ----


class CylcGraph(CylcTools):
    """
    Description
    -----------

    This is the base-class object for all Cylc engine Cylc engine
    graph applications; it is a sub-class of CylcTools.
